...
public class RobotContainer {
    ...
    ChangeRPMCommand cmdChangeRPMUp;
    ChangeRPMCommand cmdChangeRPMDown;
    ...
    private void configureCommands() {
        ...
        cmdChangeRPMUp = new ChangeRPMCommand(kShooterSubsystem, true);
        cmdChangeRPMDown = new ChangeRPMCommand(kShooterSubsystem, false);
